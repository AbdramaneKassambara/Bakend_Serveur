...
# Table pour les Disponibilites_Demande       
def create_tables_Disponibilites_Demande(cursor):
    try:
        print("Création de la table Disponibilites_Demande")
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS Disponibilites_Demande (
        ...
        print(f"Erreur lors de la création des tables Disponibilites_Demande et Jours_Disponibilite : {e}")

# Table pour les Candidatures_Tuteurat
    ...
    try:
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS Candidatures_Tuteurats (
                candidature_id INTEGER AUTOINCREMENT PRIMARY KEY,
                tuteur_id INTEGER,
                demande_id INTEGER,
...
def create_tables_Disponibilites_Tuteurs(cursor):
    try:
        ...
        print(f"Erreur lors de la création des tables Disponibilites_Tuteurs et Jours_Disponibilite : {e}")
...
def create_all_tables(cursor):
    ...
    create_tables_Disponibilites_Demande(cursor)
